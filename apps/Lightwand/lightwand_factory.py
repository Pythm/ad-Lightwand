...
def build_light(api,
    ...
    light_spec = {
        ...
        'take_manual_control': spec.options.get('take_manual_control', take_manual_control) if spec.options else take_manual_control,
        'verify_if_executed': spec.options.get('verify_if_executed', verify_if_executed) if spec.options else verify_if_executed,
